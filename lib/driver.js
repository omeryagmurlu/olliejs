...
var manualComms = function(_ollie){
	...
	// ömer
	Driver.prototype.setRandomColor = _ollie.setRandomColor = function(persist) { // not yet
	...
	Driver.prototype.setDataStreaming = _ollie.setDataStreaming = function(dataSources, opts, callback) {
		...
		var packet = commands.api.setDataStreaming(n, m, this.mask1, pcnt, this.mask2, {resetTimeout: true, requestAcknowledgement: true});
		_ollie.connection.writeCharacteristic(OllieRobotControlService,
			Roll,
			packet,
			callback
...
var insertComms = function(_ollie){
